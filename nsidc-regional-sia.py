...
def plotRegionalGraphsAntarctic(filename):
	...
	saveRegionalPlot(11, 0.0, 4.5, data, "Indian Southern Ocean NSIDC sea ice extent", "nsidc-extent-indian.png", 2) #4.4
	...
	saveRegionalPlot(14, 0, 16, data, "NSIDC Antarctic sea ice area", filenameAntarcticArea, 4)
	saveRegionalPlot(15, 0, 20, data, "NSIDC Antarctic sea ice extent", filenameAntarcticExtent, 4)
	saveRegionalPlot(14, -3, 2, data, "NSIDC Antarctic sea ice area anomaly vs. 1990-2019", filenameAntarcticAreaAnomaly, 2, True)
	saveRegionalPlot(15, -3, 2, data, "NSIDC Antarctic sea ice extent anomaly vs. 1990-2019", filenameAntarcticExtentAnomaly, 2, True)
...
def plotRegionalGraphsArctic(filename):
	...
	saveRegionalPlot(6, 0, 0.8, data, "Chukchi NSIDC sea ice area", "nsidc-area-chukchi.png", 1)
	...
	saveRegionalPlot(12, 0, 1.0, data, "Kara NSIDC sea ice area", "nsidc-area-kara.png", 1)
	saveRegionalPlot(13, 0, 1.0, data, "Kara NSIDC sea ice extent", "nsidc-extent-kara.png", 1)
	...
	saveRegionalPlot(18, 0, 1, data, "Baffin Bay NSIDC sea ice area", "nsidc-area-baffin.png", 1)
	saveRegionalPlot(19, 0, 1.3, data, "Baffin Bay NSIDC sea ice extent", "nsidc-extent-baffin.png", 1)
	...
	saveRegionalPlot(27, 0, 1, data, "Bering NSIDC sea ice extent", "nsidc-extent-bering.png", 1)
	saveRegionalPlot(28, 0, 1, data, "Okhotsk NSIDC sea ice area", "nsidc-area-okhotsk.png", 1)
	saveRegionalPlot(29, 0, 1, data, "Okhotsk NSIDC sea ice extent", "nsidc-extent-okhotsk.png", 1)
	...
	saveRegionalPlot(-2, 3, 7.3, data, "Arctic Basin NSIDC sea ice extent", filenameArcticBasinExtent, 3)
	saveRegionalPlot(-1, 0, 7.3, data, "Arctic Basin NSIDC sea ice area", filenameArcticBasinArea, 3)
	...
	saveRegionalPlot(41, 0, 12, data, "NSIDC Arctic sea ice area", filenameArcticArea, 3)
	saveRegionalPlot(42, 0, 14, data, "NSIDC Arctic sea ice extent", filenameArcticExtent, 3)	
...
def saveRegionalPlot(col, ymin, ymax, data, name, filename, legendpos=1, anomaly=False):
	...
	if col == -1:
		plt.text(35,7.05,'CAB+Beaufort+Chukchi+ESS+Laptev', fontsize=10,color='black')
	elif col == -2:
...
def getPlotMatrix(data, col):
	regional = data[1:,col]
	regional = np.array([i.lstrip() for i in regional]).astype(float)/1000.0
	offset = 245 #275 #306 #334 #62 #124 #153 #214 #245 #275 #306 #334 #31 #61 #92 #122 #153 #184 #214 #275 #61 # 0
	years = getNumberOfYears()
